...
export default function Ratings() {
  return (
    <Layout>
      <div className="bg-gray-100 h-full lg:h-screen  p-4 px-8  flex flex-col gap-4 lg:flex-row   overflow-y-auto ">
        <div className="flex flex-col justify-center w-full lg:w-1/3 h-fit align-center p-4 bg-white rounded-lg border border-gray-200">
          ...
          <div className="flex flex-row p-2">
            <img
              src="http://192.168.1.2:3000/uploads/1717424693934.png"
