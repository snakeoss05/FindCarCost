...
export default function Friends() {
  return (
    <Layout>
      <div className="bg-gray-100 lg:bg-white h-full lg:h-screen  p-4   flex flex-col gap-4 w-full lg:w-[400px] overflow-y-auto">
        ...
        <div>
          ...
          <ul className="menu px-4 gap-2">
            <li className="flex flex-row justify-center align-center gap-2 bg-white py-2 rounded-lg border border-gray-200">
              <div className="pe-2">
                <img
                  src="http://192.168.1.2:3000/uploads/1716905724747.png"
              ...
              <i className="fa-solid fa-user-minus text-red-500 text-lg hover:text-red-700 hover:scale-110 transition duration-300 cursor-pointer my-auto"></i>
            </li>
          </ul>
        </div>
      </div>
