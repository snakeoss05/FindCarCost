      ...
      <section className="bg-white ">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <aside className="relative block h-full lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
              src="https://mir-s3-cdn-cf.behance.net/project_modules/1400/1f4684197912225.6638cdb454c1c.jpg"
              className="absolute inset-0 h-full w-full object-cover"
            />
          </aside>

          <main className="flex items-center h-screen justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6 text-3xl">
                ...
                <div className="col-span-6  sm:col-span-5"></div>
                <div className="col-span-6  sm:col-span-5">
                  <label
                    htmlFor="Password"
                    className="block text-sm font-medium text-gray-700">
